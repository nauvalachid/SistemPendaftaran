<aside class="flex h-screen w-64 flex-col overflow-y-auto border-r bg-white px-5 py-8">
    <a href="#" class="flex items-center gap-x-4">
        <span class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-7 w-7 text-gray-700">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
            </svg>
        </span>
        <div>
            <h2 class="text-base font-semibold text-gray-800">Andini Septi</h2>
    ...
    <div class="flex flex-1 flex-col justify-between">
        <nav class="-mx-3 space-y-2">
            <a class="flex transform items-center rounded-lg px-3 py-2 text-gray-500 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700" href="#">
            ...
            <a class="flex transform items-center rounded-lg bg-gray-100 px-3 py-2 text-gray-900 transition-colors duration-300" href="#">
                ...
                <span class="mx-4 text-sm font-semibold">Pendaftaran</span>
            </a>
