                    ...
                    <div class="flex-grow">
                        ...
                        <dl class="divide-y divide-gray-100 border rounded-lg">
                            <div class="bg-gray-50 px-3 py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                                ...
                                <dd class="mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->id_pendaftaran }}</dd>
                            </div>
                ...
                <div class="border-t border-gray-200">
                    <dl class="divide-y divide-gray-200">
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->asal_sekolah ?? '-' }}</dd>
                        </div>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->alamat ?? '-' }}</dd>
                        </div>
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->nama_ayah ?? '-' }}</dd>
                        </div>
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Pekerjaan Ayah</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->pekerjaan_ayah ?? '-' }}</dd>
                        </div>
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Nama Ibu</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->nama_ibu ?? '-' }}</dd>
                        </div>
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Pekerjaan Ibu</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $pendaftaran->pekerjaan_ibu ?? '-' }}</dd>
                        </div>
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
...
<div id="documentModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-gray-900 bg-opacity-75 transition-opacity duration-300">
    <!-- Modal Content -->
    <div class="bg-white rounded-lg shadow-2xl w-11/12 h-5/6 max-w-5xl flex flex-col transform transition-all scale-100 ease-out duration-300">
        <!-- Header -->
        <div class="p-4 border-b flex justify-between items-center bg-gray-50">
            <h4 class="text-lg font-semibold text-gray-800">Pratinjau Dokumen Pendaftar</h4>
            <button onclick="closeDocumentModal()" class="text-gray-500 hover:text-gray-700 focus:outline-none p-1 rounded-full hover:bg-gray-200">
        ...
        <div class="p-4 border-t text-right bg-gray-50">
            <button onclick="closeDocumentModal()" class="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Tutup Pratinjau</button>
        </div>
    </div>
</div>
